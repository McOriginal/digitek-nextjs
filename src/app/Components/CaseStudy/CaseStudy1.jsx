          ...
          <div className='row'>
            ...
            <div className='col-xxl-6'>
              <div className='main-box '>
                <div className='box wow fadeInUp im1'>
                ...
                <div className='box bg-1 wow fadeInUp im2' data-wow-delay='.2s'>
                  <div className='title-items'>
                    <h3>
                      <Link href='/project/project-details'>
                        Instantly Analyze
                ...
                <div
                  className='box bg-2 active wow fadeInUp wow im3'
                  data-wow-delay='.4s'
                >
                  <div className='title-items'>
                    <h3>
                      <Link href='/project/project-details'>Web & Mobile</Link>
                    </h3>
                ...
                <div
                  className='box bg-3 wow fadeInUp wow im4'
                  data-wow-delay='.6s'
                >
                  <div className='title-items'>
                    <h3>
