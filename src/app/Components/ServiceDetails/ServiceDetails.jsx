          ...
          <div className='row g-5'>
            ...
            <div className='col-12 col-lg-8'>
              <div className='service-details-content'>
                ...
                <p className='mb-4'>
                  At tempus aenean sapien torquent sed diam className efficitur
                  mus morbi eros dictum quam augue ac laor eet ligula libero mi
                ...
                <div className='details-list-items'>
                  <ul className='details-list'>
                    <li>
                      <i className='bi bi-check-circle-fill'></i>Various
                      analysis options.
                    </li>
                    <li>
                      <i className='bi bi-check-circle-fill'></i>Advance Data
                      analysis operation.
                    </li>
                  </ul>
                  <ul className='details-list'>
                    <li>
                      <i className='bi bi-check-circle-fill'></i>Page Load
