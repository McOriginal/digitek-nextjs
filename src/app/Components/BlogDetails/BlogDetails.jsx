              ...
              <div className='news-post-details'>
                <div className='single-news-post'>
                  <div className='post-featured-thumb'>
                    <Image
                      src='/assets/img/news/two-businesswomen-discussing.jpg'
                      alt='img'
                      width={916}
                      height={547}
                    />
                    ...
                    <div className='row g-4'>
                      <div className='col-lg-6'>
                        <div className='details-image'>
                          <Image
                            src='/assets/img/news/startup-business-people.jpg'
                            alt='img'
                            width={446}
                            height={324}
                          />
                      ...
                      <div className='col-lg-6'>
                        <div className='details-image'>
                          <Image
                            src='/assets/img/news/young-man-and-woman.jpg'
                            alt='img'
                            width={446}
                            height={324}
                          />
                ...
                <div className='comments-area'>
                  ...
                  <div className='blog-single-comment d-flex gap-4 pt-4 pb-5'>
                    <div className='image'>
                      <Image
                        src='/assets/img/testimonial/f1.jpg'
                        alt='img'
                        width={96}
                        height={96}
                      />
                  ...
                  <div className='blog-single-comment d-flex gap-4 pt-4 pb-5'>
                    <div className='image'>
                      <Image
                        src='/assets/img/testimonial/f6.jpg'
                        alt='img'
                        width={96}
                        height={96}
                      />
              ...
              <div className='main-sidebar sticky-style'>
                ...
                <div className='single-sidebar-widget'>
                  ...
                  <div className='news-widget-categories'>
                    <ul>
                      <li>
                        <Link href='/blog/blog-details'>Digital Agency</Link>{' '}
                        <span>(7)</span>
                      </li>
                      <li>
                        <Link href='/blog/blog-details'>Business</Link>{' '}
                        <span>(4)</span>
                      </li>
                      <li className='active'>
                        <Link href='/blog/blog-details'>Digital Product</Link>{' '}
                        <span>(5)</span>
                      </li>
                      <li>
                        <Link href='/blog/blog-details'>Social Marketing</Link>{' '}
                        <span>(3)</span>
                      </li>
                      <li>
                        <Link href='/blog/blog-details'>System</Link>{' '}
                        <span>(6)</span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className='single-sidebar-widget'>
                  ...
                  <div className='recent-post-area'>
                    ...
                    <div className='recent-items'>
                      <div className='recent-thumb'>
                        <Image
                          src='/assets/img/news/website-development-2025-02-10-07-46-32-utc.jpg'
                          alt='img'
                          width={78}
                          height={79}
                        />
                    ...
                    <div className='recent-items'>
                      <div className='recent-thumb'>
                        <Image
                          src='/assets/img/news/big-data-domain-web.jpg'
                          alt='img'
                          width={78}
                          height={79}
                        />
