...
const Testimonial3 = () => {
  ...
  const testimonialContent = [
    {
      img: '/assets/img/testimonial/f1.jpg',
      subtitle: 'Trader, USA',
      title: 'Esther Howard',
      content:
    ...
    {
      img: '/assets/img/testimonial/f6.jpg',
      subtitle: 'Trader, USA',
      title: 'Esther Howard',
      content:
        ' Lorem ipsum dolor sit amet consectetur adipiscing elit. Mauris nullam the as integer quam dolor nunc semper.  faucibus pulvinar neque. The as Suscipit tristique mauris consectetur platea.',
      ...
      <div className='container'>
        <div className='testimonial-wrapper-3'>
          ...
          <div className='client-2'>
            <Image
              src='/assets/img/testimonial/f2.jpg'
              alt='img'
              width={62}
              height={62}
            />
          ...
          <div className='client-3'>
            <Image
              src='/assets/img/testimonial/f3.jpg'
              alt='img'
              width={56}
              height={56}
            />
          ...
          <div className='client-4'>
            <Image
              src='/assets/img/testimonial/f5.jpg'
              alt='img'
              width={80}
              height={80}
            />
